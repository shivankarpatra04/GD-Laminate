        ...
        <footer className="bg-gray-900 text-white py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* Company Info */}
                    <div>
                        <h3 className="text-xl font-bold mb-4">GT Laminate</h3>
                        <p className="text-gray-400">
                            Premium laminate solutions for your interior design needs.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            <li>123 Laminate Street</li>
                            <li>Mumbai, Maharashtra 400001</li>
                            <li>Phone: +91 98765 43210</li>
                            <li>Email: info@gtlaminate.com</li>
                        </ul>
                    </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
                    <p>&copy; {new Date().getFullYear()} GT Laminate. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
