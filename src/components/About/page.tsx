            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="md:w-1/2">
                        <h2 className="text-3xl font-bold mb-6">About GT Laminate</h2>
                        <p className="text-gray-600 mb-4">
                            GT Laminate offers premium quality laminates for all your interior design needs. With over 500+ designs and textures, we provide innovative solutions for homes, offices, and commercial spaces.
                        </p>
