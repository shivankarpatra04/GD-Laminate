  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="relative bg-green-700 text-white py-24">
        <div className="absolute inset-0 bg-gradient-to-r from-green-800 to-green-600 z-10"></div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-green-600 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-3xl mx-auto">
              We adhere to the highest environmental standards and have earned recognition from leading certification bodies.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="p-6 border border-gray-200 rounded-lg text-center">
              ...
              <h3 className="font-bold mb-2">GREENGUARD</h3>
              <p className="text-sm text-gray-600">Low Chemical Emissions</p>
            </div>
            ...
            <div className="p-6 border border-gray-200 rounded-lg text-center">
              ...
              <h3 className="font-bold mb-2">LEED Contributor</h3>
              <p className="text-sm text-gray-600">Green Building Rating System</p>
            </div>
          </div>
        </div>
      </section>
